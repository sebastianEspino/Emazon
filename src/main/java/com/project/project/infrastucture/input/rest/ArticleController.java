...
import com.project.project.application.dto.ArticleResponseDto;
...
public class ArticleController {
    ...
    @PostMapping("/")
    public ResponseEntity<Void> saveArticle(@Valid @RequestBody ArticleRequestDto articleRequestDto) {
